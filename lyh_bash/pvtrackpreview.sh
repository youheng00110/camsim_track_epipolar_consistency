...
torchrun \
  ...
  --nproc_per_node=4 \
  -m dwm.preview \
  -c "/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/lyh/PV_track_train4cardpreview.json"\
  -o "/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/lyh_output/debug_pvtrack"
