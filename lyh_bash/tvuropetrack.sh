...
torchrun \
  --nproc_per_node=4 \
  -m dwm.train \
  -c //inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/lyh/PV_track_urope_tv_temporal_ring_tself_train.json\
  -o /inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/lyh_output/train_uropetvtrack \
  --log-steps 300 \
  --preview-steps 1000 \
