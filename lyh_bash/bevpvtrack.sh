...
torchrun \
  --nproc_per_node=8 \
  -m dwm.train \
  -c //inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/lyh/BEV_PV_plucker_train_av2pvbev.json\
  -o /inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/lyh_output/run_bevpvtrack\
  --log-steps 300 \
  --preview-steps 1000 \
