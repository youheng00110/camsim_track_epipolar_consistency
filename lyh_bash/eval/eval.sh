cat > /inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/eval_nuplan6hz_300.sh <<'SH'
#!/bin/bash
...
chmod +x \
/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/eval_nuplan6hz_300.sh
