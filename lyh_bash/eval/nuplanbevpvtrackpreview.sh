...
torchrun \
  ...
  --nproc_per_node=4 \
  -m dwm.preview \
  -c "/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/lyh/BEV_PV_plucker_train_av2pvbevpreview.json"\
  -o "/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/lyh_output/debug_pvbev"
