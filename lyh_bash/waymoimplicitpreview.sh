...
CONFIG="/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/lyh/waymopreview/waymoimplicitpreview_18000_1000.json"
OUTPUT="/inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/lyh_output/waymo_preview/implicit_6hz_18000_1000"

echo "Starting Waymo implicit 18000 preview (target 1000)"
echo "CONFIG=${CONFIG}"
echo "OUTPUT=${OUTPUT}"
...
torchrun \
  ...
  -o "${OUTPUT}"
STATUS=$?
echo "Waymo implicit preview status=${STATUS}"
exit "${STATUS}"
