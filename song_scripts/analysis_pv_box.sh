...
torchrun \
  ...
  -c /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/song/pv_analysis_box.json \
  -o /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output_song/pv_analysis/box \
  --sample-count 100 \
  --sample-stride 10