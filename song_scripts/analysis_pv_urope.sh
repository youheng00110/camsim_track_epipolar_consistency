...
torchrun \
  --nproc_per_node=1 \
    ...
    -c /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/song/pv_analysis_urope.json \
    -o /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output_song/pv_analysis/pv-urope2 \
    --sample-count 100 \
    --causal-sample-count 100 \
    --sigmas 0.9 0.6 0.3 \
    --auc-weight 0.50
  # -m dwm.analyze_entity_reactor \
  # -c /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/song/pv_analysis_urope.json \
  # -o /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output_song/pv_analysis/pv-urope \
  # --sample-count 100 \
  # --sample-stride 10 
