...
torchrun \
  --nproc_per_node=4 \
  -m dwm.train \
  -c /inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/OpenDWM/configs/song/PV_track_train4card.json \
  -o /inspire/qb-ilm/project/quantum-artificial-intelligence/yanjunchi-24040/songbur/camsim/song_output/pvtrack2 \
  --log-steps 300 \
  --preview-steps 1000 \
