...
torchrun \
  ...
  -c /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/OpenDWM/configs/song/pv_analysis.json \
  --checkpoint /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output/train_nuplanfull/checkpoints \
  -o /inspire/qb-ilm/project/advanced-machine-learning/yanjunchi-24040/camsim_lyh/output_song/pv_analysis/pv-step \
  --sample-count 100 \
