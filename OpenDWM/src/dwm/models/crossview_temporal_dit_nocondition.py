...
class DiTCrossviewTemporalConditionModel(diffusers.SD3Transformer2DModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Hard disable PV layout condition.
        # This model variant only uses text embedding, camera geometry, and reference frames.
        self.condition_image_adapter = None
        self.disable_pv_condition = True
    ...
    def forward(
        ...
        **unused_kwargs,
        ...
        if getattr(self, "disable_pv_condition", False):
        ...
        # PV layout residuals are hard disabled in this no-condition model.
