...
class MotionDataset(torch.utils.data.Dataset):
    ...
    def get_layout_token_boxes(
        ...
        view_count = max(1, len(cam_infos))
        ...
        for i, box in enumerate(boxes):
            ...
            for view_idx in range(view_count):
                ...
                if img_sizes is not None and cam_Ks is not None:
    ...
    def __getitem__(self, index):
        ...
        # Instance-level GT boxes.
        #
        # This remains a Python nested list because each frame can contain
        ...
        # Fixed-shape camera_from_lidar transforms:
        #     [T, V, 4, 4]
        #
        # We deliberately save lidar_to_camera rather than a precomputed
        # lidar_to_image matrix. DatasetAdapter may resize/crop the images
        # and update camera_intrinsics afterwards. preview.py will combine
        # the final updated K with this rigid transform.
        lidar_to_camera = []
